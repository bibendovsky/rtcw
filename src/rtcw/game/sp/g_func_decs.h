...
extern const char * ClientConnect ( int clientNum , qboolean firstTime , qboolean isBot ) ;
...
extern qboolean AICast_ScriptAction_CatchFire ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_PushAway ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_AnimCondition ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_LockPlayer ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_ExplicitRouting ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_MusicQueue ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_MusicFade ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_MusicStop ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_MusicPlay ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_MusicStart ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Cvar ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_NoTarget ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SetHealth ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_AIScriptName ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_EntityScriptName ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Parachute ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Cigarette ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_StopCam ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_StopCamBlack ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_StartCamBlack ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_StartCam ( cast_state_t * cs , const char* params ) ;
extern qboolean ScriptStartCam ( cast_state_t * cs , const char* params , qboolean black ) ;
extern qboolean AICast_ScriptAction_Zoom ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_KnockBack ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_StateType ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_RestoreScript ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_BackupScript ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Headlook ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_LightningDamage ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_DenyAction ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Attrib ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Avoid ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_NoAvoid ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Sight ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_NoSight ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_FoundSecret ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_ChangeLevel ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_EndGame ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Teleport ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SavePersistant ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Unmount ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Mount ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_ResetScript ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_FaceTargetAngles ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Print ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_NoAIDamage ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_ObjectiveMet ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_ObjectivesNeeded ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_MissionFailed ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SpawnCast ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Accum ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_GodMode ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_FireAtTarget ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SaveGame ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_AlertEntity ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Movetype ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_GiveInventory ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_TakeWeapon ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_GiveWeapon ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_GiveArmor ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SetArmor ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SelectWeapon ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SuggestWeapon ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SetClip ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_SetAmmo ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_ClearAnim ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_PlayAnim ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Attack ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_NoAttack ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_PlaySound ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_FollowCast ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Trigger ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_Wait ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_AbortIfLoadgame ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_CrouchToCast ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_WalkToCast ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_GotoCast ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_CrouchToMarker ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_WalkToMarker ( cast_state_t * cs , const char* params ) ;
extern qboolean AICast_ScriptAction_GotoMarker ( cast_state_t * cs , const char* params ) ;
...
extern int BG_PlayAnimName ( playerState_t * ps , const char * animName , animBodyPart_t bodyPart , qboolean setTimer , qboolean isContinue , qboolean force ) ;
...
extern qboolean G_ScriptAction_SetHealth ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_RestoreScript ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_BackupScript ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetRoundTimelimit ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_EndRound ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Announce ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetObjectiveStatus ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetWinner ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ObjectiveAlliedDesc ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ObjectiveAxisDesc ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_NumberofObjectives ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AlliedRespawntime ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AxisRespawntime ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_MapDescription ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AIScriptName ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_EntityScriptName ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_StartCam ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_StopSound ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Halt ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_TagConnect ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ResetScript ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_FaceAngles ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Print ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_MissionSuccess ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_MissionFailed ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Accum ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AlertEntity ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_PlayAnim ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_MusicQueue ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_MusicFade ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_MusicStop ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_MusicPlay ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_MusicStart ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_PlaySound ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Trigger ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Wait ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_GotoMarker ( gentity_t * ent , const char* params ) ;
...
extern const char * SkipWhitespace ( const char * data , qboolean * hasNewLines ) ;
extern void COM_ParseWarning ( const char * format , ... ) ;
extern void COM_ParseError ( const char * format , ... ) ;
...
extern const char * AIFunc_ChaseGoalStart ( cast_state_t * cs , int entitynum , float reachdist , qboolean slowApproach ) ;
...
extern gentity_t * G_PickTarget ( const char * targetname ) ;
...
extern qboolean AICast_EventMatch_IntInRange ( cast_script_event_t * event , const char * eventParm ) ;
extern qboolean AICast_EventMatch_StringEqual ( cast_script_event_t * event , const char * eventParm ) ;
...
extern void AICast_DBG_Spawn_f ( gclient_t * client , const char * cmd ) ;
...
extern void G_Script_ScriptEvent ( gentity_t * ent , const char * eventStr , const char * params ) ;
...
extern qboolean G_Script_EventMatch_IntInRange ( g_script_event_t * event , const char * eventParm ) ;
extern qboolean G_Script_EventMatch_StringEqual ( g_script_event_t * event , const char * eventParm ) ;
...
extern void trap_BotReplaceSynonyms ( char * string , uint32_t context ) ;
extern void trap_UnifyWhiteSpaces ( char * string ) ;
extern void trap_BotMatchVariable ( void * match , int variable , char * buf , int size ) ;
extern int trap_BotFindMatch ( char * str , void * match , uint32_t context ) ;
...
extern int trap_BotNumInitialChats ( int chatstate , const char * type ) ;
extern void trap_BotInitialChat ( int chatstate , const char * type , int mcontext , const char * var0 , const char * var1 , const char * var2 , const char * var3 , const char * var4 , const char * var5 , const char * var6 , const char * var7 ) ;
...
extern void trap_EA_SayTeam ( int client , const char * str ) ;
...
extern int trap_AAS_ValueForBSPEpairKey ( int ent , const char * key , const char * value , int size ) ;
...
extern qboolean trap_GetTag ( int clientNum , const char * tagName , orientation_t * orient ) ;
...
extern gentity_t * AICast_FindEntityForName ( const char * name ) ;
extern void AICast_Init ( void ) ;
extern gentity_t * AICast_CreateCharacter ( gentity_t * ent , float * attributes , cast_weapon_info_t * weaponInfo , const char * castname , const char * model , const char * head , const char * sex , const char * color , const char * handicap ) ;
extern void AICast_SetAASIndex ( cast_state_t * cs ) ;
extern void AICast_CheckLevelAttributes ( cast_state_t * cs , gentity_t * ent , const char * * ppStr ) ;
extern gentity_t * AICast_AddCastToGame ( gentity_t * ent , const char * castname , const char * model , const char * head , const char * sex , const char * color , const char * handicap ) ;
...
extern qboolean G_SavePersistant ( const char * nextmap ) ;
...
extern qboolean G_SaveGame ( const char * username ) ;
...
extern Function G_FindFuncByName(const char* name);
extern funcList_t* G_FindFuncAtAddress(Function adr);
