...
extern void G_PrintClientSpammyCenterPrint ( int entityNum , const char * text ) ;
...
extern qboolean G_FilterMaxLivesPacket ( const char * from ) ;
extern qboolean G_FilterMaxLivesIPPacket ( const char * from ) ;
extern qboolean G_FilterIPBanPacket ( const char * from ) ;
extern qboolean G_FilterPacket ( ipFilterList_t * ipFilterList , const char * from ) ;
extern ipXPStorage_t * G_FindIpData ( ipXPStorageList_t * ipXPStorageList , const char * from ) ;
...
extern qboolean etpro_ScriptAction_SetValues ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AbortIfNotSinglePlayer ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AbortIfWarmup ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Cvar ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SpawnBot ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ConstructibleDuration ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ConstructibleWeaponclass ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ConstructibleHealth ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ConstructibleDestructXPBonus ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ConstructibleConstructXPBonus ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ConstructibleChargeBarReq ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ConstructibleClass ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Construct ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetBotGoalPriority ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetAASState ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetBotGoalState ( gentity_t * ent , const char* params ) ;
extern qboolean G_IsValidBotStateGoal ( gentity_t * ent ) ;
extern qboolean G_ScriptAction_BotDebugging ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_RemoveBot ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_PrintGlobalAccum ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_PrintAccum ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetHQStatus ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_RepairMG42 ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_StopCam ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetInitialCamera ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_StartCam ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetState ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetDamagable ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_RemoveEntity ( gentity_t * ent , const char* params ) ;
...
extern qboolean G_ScriptAction_Announce_Icon ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_TeamVoiceAnnounce ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_RemoveTeamVoiceAnnounce ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AddTeamVoiceAnnounce ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetDefendingTeam ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetWinner ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_VoiceAnnounce ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetDebugLevel ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ObjectiveStatus ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetMainObjective ( gentity_t * ent , const char* params ) ;
...
extern qboolean G_ScriptAction_GlobalAccum ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Accum ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_EnableSpeaker ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_DisableSpeaker ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ToggleSpeaker ( gentity_t * ent , const char* params ) ;
...
extern qboolean G_ScriptAction_FadeAllSounds ( gentity_t * ent , const char* params ) ;
...
extern qboolean G_ScriptAction_SetGlobalFog ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_Kill ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_DisableMessage ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AddTankAmmo ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetTankAmmo ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AllowTankEnter ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AllowTankExit ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SpawnRubble ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetChargeTimeFactor ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AbortMove ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_FollowSpline ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_StopRotation ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetRotation ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetSpeed ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_StartAnimation ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_UnFreezeAnimation ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_FreezeAnimation ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_AttatchToTrain ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_FollowPath ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ShaderRemapFlush ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ShaderRemap ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_ChangeModel ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetAutoSpawn ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetPosition ( gentity_t * ent , const char* params ) ;
extern qboolean G_ScriptAction_SetModelFromBrushmodel ( gentity_t * ent , const char* params ) ;
...
extern int G_Script_GetEventIndex ( gentity_t * ent , const char * eventStr , const char* params ) ;
...
extern void G_Script_ParseSpawnbot ( const char * * ppScript , char params [ ] , int paramsize ) ;
...
extern void G_printFull ( const char * str , gentity_t * ent ) ;
...
extern qboolean G_commandHelp ( gentity_t * ent , const char * pszCommand , unsigned int dwCommand ) ;
...
extern qboolean SetTeam ( gentity_t * ent , const char * s , qboolean force , weapon_t w1 , weapon_t w2 , qboolean setweapons ) ;
