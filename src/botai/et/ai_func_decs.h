...
extern qboolean Bot_ScriptAction_SetCivilian ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetAmmoAmount ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetScriptAutonomy ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_FireAtTarget ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_Announce ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetActiveWeapon ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetSpeedCoefficient ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetCloseHearingRange ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetFarSeeingRange ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetVisionRange ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetFireCycleTime ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetFireRate ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_BotDebugging ( gentity_t * ent , const char* params ) ;
extern qboolean Bot_ScriptAction_PrintGlobalAccum ( gentity_t * ent , const char* params ) ;
extern qboolean Bot_ScriptAction_PrintAccum ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetProne ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetCrouch ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetHearingRange ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetFieldOfView ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_ResetScript ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_NoTarget ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_MovementAutonomy ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetMovementAutonomy ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_Cvar ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_FollowLeader ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_GlobalAccum ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetClass ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetWeapon ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_PlaySoundAtPlayer ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_MountMG42 ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetAttribute ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_AbortIfWarmup ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_Logging ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_Trigger ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_MoveToMarker ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_Wait ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_Accum ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SpawnBot ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_SetAccumToPlayerCount ( bot_state_t * bs , const char* params ) ;
extern qboolean Bot_ScriptAction_Print ( bot_state_t * bs , const char* params ) ;
extern void Bot_ScriptError ( bot_state_t * bs , const char * fmt , ... ) ;
extern qboolean Bot_ScriptAction_SetSpeed ( bot_state_t * bs , const char* params ) ;
extern void Bot_ScriptThink ( void ) ;
extern void Bot_ScriptLog_Entry ( bot_state_t * bs , qboolean showDetails , const char * preText , const char * fmt , ... ) ;
extern int Bot_Script_GetCurrentLine ( bot_state_t * bs ) ;
extern qboolean Bot_ScriptRun ( bot_state_t * bs , qboolean force ) ;
extern void Bot_TeamScriptEvent ( int team , const char * eventStr , const char* params ) ;
extern void Bot_ForceScriptEvent ( int entityNum , char * eventStr , const char* params ) ;
extern void Bot_ScriptEvent ( int entityNum , const char * eventStr , const char* params ) ;
extern void Bot_ScriptChange ( bot_state_t * bs , int newScriptNum ) ;
extern const char * Bot_LineText ( const char * text ) ;
extern qboolean Bot_ScriptInitBot ( int entnum ) ;
extern void Bot_ScriptParse ( bot_script_data_t * bsd , const char * * text ) ;
...
extern gentity_t * BotFindEntity ( gentity_t * from , int fieldofs , const char * match ) ;
...
extern void ParseBotDefaultAttributes ( const char * fileName ) ;
...
extern void QDECL BotAI_BotInitialChat ( bot_state_t * bs , const char * type , ... ) ;
...
extern void QDECL BotAI_Print ( int type , const char * fmt , ... ) ;
...
extern int BotScriptAutonomyForString ( const char * string ) ;
extern const char * BotStringForWeaponAutonomy ( int value ) ;
extern int BotWeaponAutonomyForString ( char * string ) ;
extern const char * BotStringForMovementAutonomy ( int value ) ;
extern int BotMovementAutonomyForString ( const char * string ) ;
...
extern void BotDontAvoid ( bot_state_t * bs , const char * itemname ) ;
...
extern const char * EasyClientName ( int client , char * buf , int size ) ;
extern char * stristr ( char * str , char * charset ) ;
extern int ClientFromName ( char * name ) ;
extern const char * ClientSkin ( int client , char * skin , int size ) ;
extern const char * ClientName ( int client , char * name , int size ) ;
...
extern float BotNearestVisibleItem ( bot_state_t * bs , const char * itemname , bot_goal_t * goal ) ;
