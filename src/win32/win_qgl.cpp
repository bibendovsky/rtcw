...
qboolean QGL_Init( const char *dllname ) {
	...
	qglAccum                     = dllAccum = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat)> (GPA( "glAccum" ));
	qglAlphaFunc                 = dllAlphaFunc = reinterpret_cast<void (WINAPI*) (GLenum, GLclampf)> (GPA( "glAlphaFunc" ));
	qglAreTexturesResident       = dllAreTexturesResident = reinterpret_cast<GLboolean (WINAPI*) (GLsizei, const GLuint*, GLboolean*)> (GPA( "glAreTexturesResident" ));
	qglArrayElement              = dllArrayElement = reinterpret_cast<void (WINAPI*) (GLint)> (GPA( "glArrayElement" ));
	qglBegin                     = dllBegin = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glBegin" ));
	qglBindTexture               = dllBindTexture = reinterpret_cast<void (WINAPI*) (GLenum, GLuint)> (GPA( "glBindTexture" ));
	qglBitmap                    = dllBitmap = reinterpret_cast<void (WINAPI*) (GLsizei, GLsizei, GLfloat, GLfloat, GLfloat, GLfloat, const GLubyte*)> (GPA( "glBitmap" ));
	qglBlendFunc                 = dllBlendFunc = reinterpret_cast<void (WINAPI*) (GLenum, GLenum)> (GPA( "glBlendFunc" ));
	qglCallList                  = dllCallList = reinterpret_cast<void (WINAPI*) (GLuint)> (GPA( "glCallList" ));
	qglCallLists                 = dllCallLists = reinterpret_cast<void (WINAPI*) (GLsizei, GLenum, const GLvoid*)> (GPA( "glCallLists" ));
	qglClear                     = dllClear = reinterpret_cast<void (WINAPI*) (GLbitfield)> (GPA( "glClear" ));
	qglClearAccum                = dllClearAccum = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat, GLfloat)> (GPA( "glClearAccum" ));
	qglClearColor                = dllClearColor = reinterpret_cast<void (WINAPI*) (GLclampf, GLclampf, GLclampf, GLclampf)> (GPA( "glClearColor" ));
	qglClearDepth                = dllClearDepth = reinterpret_cast<void (WINAPI*) (GLclampd)> (GPA( "glClearDepth" ));
	qglClearIndex                = dllClearIndex = reinterpret_cast<void (WINAPI*) (GLfloat)> (GPA( "glClearIndex" ));
	qglClearStencil              = dllClearStencil = reinterpret_cast<void (WINAPI*) (GLint)> (GPA( "glClearStencil" ));
	qglClipPlane                 = dllClipPlane = reinterpret_cast<void (WINAPI*) (GLenum, const GLdouble*)> (GPA( "glClipPlane" ));
	qglColor3b                   = dllColor3b = reinterpret_cast<void (WINAPI*) (GLbyte, GLbyte, GLbyte)> (GPA( "glColor3b" ));
	qglColor3bv                  = dllColor3bv = reinterpret_cast<void (WINAPI*) (const GLbyte*)> (GPA( "glColor3bv" ));
	qglColor3d                   = dllColor3d = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble)> (GPA( "glColor3d" ));
	qglColor3dv                  = dllColor3dv = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glColor3dv" ));
	qglColor3f                   = dllColor3f = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat)> (GPA( "glColor3f" ));
	qglColor3fv                  = dllColor3fv = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glColor3fv" ));
	qglColor3i                   = dllColor3i = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint)> (GPA( "glColor3i" ));
	qglColor3iv                  = dllColor3iv = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glColor3iv" ));
	qglColor3s                   = dllColor3s = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort)> (GPA( "glColor3s" ));
	qglColor3sv                  = dllColor3sv = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glColor3sv" ));
	qglColor3ub                  = dllColor3ub = reinterpret_cast<void (WINAPI*) (GLubyte, GLubyte, GLubyte)> (GPA( "glColor3ub" ));
	qglColor3ubv                 = dllColor3ubv = reinterpret_cast<void (WINAPI*) (const GLubyte*)> (GPA( "glColor3ubv" ));
	qglColor3ui                  = dllColor3ui = reinterpret_cast<void (WINAPI*) (GLuint, GLuint, GLuint)> (GPA( "glColor3ui" ));
	qglColor3uiv                 = dllColor3uiv = reinterpret_cast<void (WINAPI*) (const GLuint*)> (GPA( "glColor3uiv" ));
	qglColor3us                  = dllColor3us = reinterpret_cast<void (WINAPI*) (GLushort, GLushort, GLushort)> (GPA( "glColor3us" ));
	qglColor3usv                 = dllColor3usv = reinterpret_cast<void (WINAPI*) (const GLushort*)> (GPA( "glColor3usv" ));
	qglColor4b                   = dllColor4b = reinterpret_cast<void (WINAPI*) (GLbyte, GLbyte, GLbyte, GLbyte)> (GPA( "glColor4b" ));
	qglColor4bv                  = dllColor4bv = reinterpret_cast<void (WINAPI*) (const GLbyte*)> (GPA( "glColor4bv" ));
	qglColor4d                   = dllColor4d = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble, GLdouble)> (GPA( "glColor4d" ));
	qglColor4dv                  = dllColor4dv = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glColor4dv" ));
	qglColor4f                   = dllColor4f = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat, GLfloat)> (GPA( "glColor4f" ));
	qglColor4fv                  = dllColor4fv = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glColor4fv" ));
	qglColor4i                   = dllColor4i = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint, GLint)> (GPA( "glColor4i" ));
	qglColor4iv                  = dllColor4iv = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glColor4iv" ));
	qglColor4s                   = dllColor4s = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort, GLshort)> (GPA( "glColor4s" ));
	qglColor4sv                  = dllColor4sv = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glColor4sv" ));
	qglColor4ub                  = dllColor4ub = reinterpret_cast<void (WINAPI*) (GLubyte, GLubyte, GLubyte, GLubyte)> (GPA( "glColor4ub" ));
	qglColor4ubv                 = dllColor4ubv = reinterpret_cast<void (WINAPI*) (const GLubyte*)> (GPA( "glColor4ubv" ));
	qglColor4ui                  = dllColor4ui = reinterpret_cast<void (WINAPI*) (GLuint, GLuint, GLuint, GLuint)> (GPA( "glColor4ui" ));
	qglColor4uiv                 = dllColor4uiv = reinterpret_cast<void (WINAPI*) (const GLuint*)> (GPA( "glColor4uiv" ));
	qglColor4us                  = dllColor4us = reinterpret_cast<void (WINAPI*) (GLushort, GLushort, GLushort, GLushort)> (GPA( "glColor4us" ));
	qglColor4usv                 = dllColor4usv = reinterpret_cast<void (WINAPI*) (const GLushort*)> (GPA( "glColor4usv" ));
	qglColorMask                 = dllColorMask = reinterpret_cast<void (WINAPI*) (GLboolean, GLboolean, GLboolean, GLboolean)> (GPA( "glColorMask" ));
	qglColorMaterial             = dllColorMaterial = reinterpret_cast<void (WINAPI*) (GLenum, GLenum)> (GPA( "glColorMaterial" ));
	qglColorPointer              = dllColorPointer = reinterpret_cast<void (WINAPI*) (GLint, GLenum, GLsizei, const GLvoid*)> (GPA( "glColorPointer" ));
	qglCopyPixels                = dllCopyPixels = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLsizei, GLsizei, GLenum)> (GPA( "glCopyPixels" ));
	qglCopyTexImage1D            = dllCopyTexImage1D = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLint)> (GPA( "glCopyTexImage1D" ));
	qglCopyTexImage2D            = dllCopyTexImage2D = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLenum, GLint, GLint, GLsizei, GLsizei, GLint)> (GPA( "glCopyTexImage2D" ));
	qglCopyTexSubImage1D         = dllCopyTexSubImage1D = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLint, GLint, GLint, GLsizei)> (GPA( "glCopyTexSubImage1D" ));
	qglCopyTexSubImage2D         = dllCopyTexSubImage2D = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei)> (GPA( "glCopyTexSubImage2D" ));
	qglCullFace                  = dllCullFace = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glCullFace" ));
	qglDeleteLists               = dllDeleteLists = reinterpret_cast<void (WINAPI*) (GLuint, GLsizei)> (GPA( "glDeleteLists" ));
	qglDeleteTextures            = dllDeleteTextures = reinterpret_cast<void (WINAPI*) (GLsizei, const GLuint*)> (GPA( "glDeleteTextures" ));
	qglDepthFunc                 = dllDepthFunc = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glDepthFunc" ));
	qglDepthMask                 = dllDepthMask = reinterpret_cast<void (WINAPI*) (GLboolean)> (GPA( "glDepthMask" ));
	qglDepthRange                = dllDepthRange = reinterpret_cast<void (WINAPI*) (GLclampd, GLclampd)> (GPA( "glDepthRange" ));
	qglDisable                   = dllDisable = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glDisable" ));
	qglDisableClientState        = dllDisableClientState = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glDisableClientState" ));
	qglDrawArrays                = dllDrawArrays = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLsizei)> (GPA( "glDrawArrays" ));
	qglDrawBuffer                = dllDrawBuffer = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glDrawBuffer" ));
	qglDrawElements              = dllDrawElements = reinterpret_cast<void (WINAPI*) (GLenum, GLsizei, GLenum, const GLvoid*)> (GPA( "glDrawElements" ));
	qglDrawPixels                = dllDrawPixels = reinterpret_cast<void (WINAPI*) (GLsizei, GLsizei, GLenum, GLenum, const GLvoid*)> (GPA( "glDrawPixels" ));
	qglEdgeFlag                  = dllEdgeFlag = reinterpret_cast<void (WINAPI*) (GLboolean)> (GPA( "glEdgeFlag" ));
	qglEdgeFlagPointer           = dllEdgeFlagPointer = reinterpret_cast<void (WINAPI*) (GLsizei, const GLvoid*)> (GPA( "glEdgeFlagPointer" ));
	qglEdgeFlagv                 = dllEdgeFlagv = reinterpret_cast<void (WINAPI*) (const GLboolean*)> (GPA( "glEdgeFlagv" ));
	qglEnable                    =  dllEnable                    = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glEnable" ));
	qglEnableClientState         =  dllEnableClientState         = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glEnableClientState" ));
	qglEnd                       =  dllEnd                       = reinterpret_cast<void (WINAPI*) ()> (GPA( "glEnd" ));
	qglEndList                   =  dllEndList                   = reinterpret_cast<void (WINAPI*) ()> (GPA( "glEndList" ));
	qglEvalCoord1d               =  dllEvalCoord1d               = reinterpret_cast<void (WINAPI*) (GLdouble)> (GPA( "glEvalCoord1d" ));
	qglEvalCoord1dv              =  dllEvalCoord1dv              = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glEvalCoord1dv" ));
	qglEvalCoord1f               =  dllEvalCoord1f               = reinterpret_cast<void (WINAPI*) (GLfloat)> (GPA( "glEvalCoord1f" ));
	qglEvalCoord1fv              =  dllEvalCoord1fv              = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glEvalCoord1fv" ));
	qglEvalCoord2d               =  dllEvalCoord2d               = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble)> (GPA( "glEvalCoord2d" ));
	qglEvalCoord2dv              =  dllEvalCoord2dv              = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glEvalCoord2dv" ));
	qglEvalCoord2f               =  dllEvalCoord2f               = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat)> (GPA( "glEvalCoord2f" ));
	qglEvalCoord2fv              =  dllEvalCoord2fv              = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glEvalCoord2fv" ));
	qglEvalMesh1                 =  dllEvalMesh1                 = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLint)> (GPA( "glEvalMesh1" ));
	qglEvalMesh2                 =  dllEvalMesh2                 = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLint, GLint, GLint)> (GPA( "glEvalMesh2" ));
	qglEvalPoint1                =  dllEvalPoint1                = reinterpret_cast<void (WINAPI*) (GLint)> (GPA( "glEvalPoint1" ));
	qglEvalPoint2                =  dllEvalPoint2                = reinterpret_cast<void (WINAPI*) (GLint, GLint)> (GPA( "glEvalPoint2" ));
	qglFeedbackBuffer            =  dllFeedbackBuffer            = reinterpret_cast<void (WINAPI*) (GLsizei, GLenum, GLfloat*)> (GPA( "glFeedbackBuffer" ));
	qglFinish                    =  dllFinish                    = reinterpret_cast<void (WINAPI*) ()> (GPA( "glFinish" ));
	qglFlush                     =  dllFlush                     = reinterpret_cast<void (WINAPI*) ()> (GPA( "glFlush" ));
	qglFogf                      =  dllFogf                      = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat)> (GPA( "glFogf" ));
	qglFogfv                     =  dllFogfv                     = reinterpret_cast<void (WINAPI*) (GLenum, const GLfloat*)> (GPA( "glFogfv" ));
	qglFogi                      =  dllFogi                      = reinterpret_cast<void (WINAPI*) (GLenum, GLint)> (GPA( "glFogi" ));
	qglFogiv                     =  dllFogiv                     = reinterpret_cast<void (WINAPI*) (GLenum, const GLint*)> (GPA( "glFogiv" ));
	qglFrontFace                 =  dllFrontFace                 = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glFrontFace" ));
	qglFrustum                   =  dllFrustum                   = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble)> (GPA( "glFrustum" ));
	qglGenLists                  =  dllGenLists                  = reinterpret_cast<GLuint (WINAPI*) (GLsizei)> (GPA( "glGenLists" ));
	qglGenTextures               =  dllGenTextures               = reinterpret_cast<void (WINAPI*) (GLsizei, GLuint*)> (GPA( "glGenTextures" ));
	qglGetBooleanv               =  dllGetBooleanv               = reinterpret_cast<void (WINAPI*) (GLenum, GLboolean*)> (GPA( "glGetBooleanv" ));
	qglGetClipPlane              =  dllGetClipPlane              = reinterpret_cast<void (WINAPI*) (GLenum, GLdouble*)> (GPA( "glGetClipPlane" ));
	qglGetDoublev                =  dllGetDoublev                = reinterpret_cast<void (WINAPI*) (GLenum, GLdouble*)> (GPA( "glGetDoublev" ));
	qglGetError                  =  dllGetError                  = reinterpret_cast<GLenum (WINAPI*) ()> (GPA( "glGetError" ));
	qglGetFloatv                 =  dllGetFloatv                 = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat*)> (GPA( "glGetFloatv" ));
	qglGetIntegerv               =  dllGetIntegerv               = reinterpret_cast<void (WINAPI*) (GLenum, GLint*)> (GPA( "glGetIntegerv" ));
	qglGetLightfv                =  dllGetLightfv                = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat*)> (GPA( "glGetLightfv" ));
	qglGetLightiv                =  dllGetLightiv                = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint*)> (GPA( "glGetLightiv" ));
	qglGetMapdv                  =  dllGetMapdv                  = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLdouble*)> (GPA( "glGetMapdv" ));
	qglGetMapfv                  =  dllGetMapfv                  = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat*)> (GPA( "glGetMapfv" ));
	qglGetMapiv                  =  dllGetMapiv                  = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint*)> (GPA( "glGetMapiv" ));
	qglGetMaterialfv             =  dllGetMaterialfv             = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat*)> (GPA( "glGetMaterialfv" ));
	qglGetMaterialiv             =  dllGetMaterialiv             = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint*)> (GPA( "glGetMaterialiv" ));
	qglGetPixelMapfv             =  dllGetPixelMapfv             = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat*)> (GPA( "glGetPixelMapfv" ));
	qglGetPixelMapuiv            =  dllGetPixelMapuiv            = reinterpret_cast<void (WINAPI*) (GLenum, GLuint*)> (GPA( "glGetPixelMapuiv" ));
	qglGetPixelMapusv            =  dllGetPixelMapusv            = reinterpret_cast<void (WINAPI*) (GLenum, GLushort*)> (GPA( "glGetPixelMapusv" ));
	qglGetPointerv               =  dllGetPointerv               = reinterpret_cast<void (WINAPI*) (GLenum, GLvoid**)> (GPA( "glGetPointerv" ));
	qglGetPolygonStipple         =  dllGetPolygonStipple         = reinterpret_cast<void (WINAPI*) (GLubyte*)> (GPA( "glGetPolygonStipple" ));
	qglGetString                 =  dllGetString                 = reinterpret_cast<const GLubyte* (WINAPI*) (GLenum)> (GPA( "glGetString" ));
	qglGetTexEnvfv               =  dllGetTexEnvfv               = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat*)> (GPA( "glGetTexEnvfv" ));
	qglGetTexEnviv               =  dllGetTexEnviv               = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint*)> (GPA( "glGetTexEnviv" ));
	qglGetTexGendv               =  dllGetTexGendv               = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLdouble*)> (GPA( "glGetTexGendv" ));
	qglGetTexGenfv               =  dllGetTexGenfv               = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat*)> (GPA( "glGetTexGenfv" ));
	qglGetTexGeniv               =  dllGetTexGeniv               = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint*)> (GPA( "glGetTexGeniv" ));
	qglGetTexImage               =  dllGetTexImage               = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLenum, GLenum, GLvoid*)> (GPA( "glGetTexImage" ));
	qglGetTexParameterfv         =  dllGetTexParameterfv         = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat*)> (GPA( "glGetTexParameterfv" ));
	qglGetTexParameteriv         =  dllGetTexParameteriv         = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint*)> (GPA( "glGetTexParameteriv" ));
	qglHint                      =  dllHint                      = reinterpret_cast<void (WINAPI*) (GLenum, GLenum)> (GPA( "glHint" ));
	qglIndexMask                 =  dllIndexMask                 = reinterpret_cast<void (WINAPI*) (GLuint)> (GPA( "glIndexMask" ));
	qglIndexPointer              =  dllIndexPointer              = reinterpret_cast<void (WINAPI*) (GLenum, GLsizei, const GLvoid*)> (GPA( "glIndexPointer" ));
	qglIndexd                    =  dllIndexd                    = reinterpret_cast<void (WINAPI*) (GLdouble)> (GPA( "glIndexd" ));
	qglIndexdv                   =  dllIndexdv                   = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glIndexdv" ));
	qglIndexf                    =  dllIndexf                    = reinterpret_cast<void (WINAPI*) (GLfloat)> (GPA( "glIndexf" ));
	qglIndexfv                   =  dllIndexfv                   = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glIndexfv" ));
	qglIndexi                    =  dllIndexi                    = reinterpret_cast<void (WINAPI*) (GLint)> (GPA( "glIndexi" ));
	qglIndexiv                   =  dllIndexiv                   = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glIndexiv" ));
	qglIndexs                    =  dllIndexs                    = reinterpret_cast<void (WINAPI*) (GLshort)> (GPA( "glIndexs" ));
	qglIndexsv                   =  dllIndexsv                   = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glIndexsv" ));
	qglIndexub                   =  dllIndexub                   = reinterpret_cast<void (WINAPI*) (GLubyte)> (GPA( "glIndexub" ));
	qglIndexubv                  =  dllIndexubv                  = reinterpret_cast<void (WINAPI*) (const GLubyte*)> (GPA( "glIndexubv" ));
	qglInitNames                 =  dllInitNames                 = reinterpret_cast<void (WINAPI*) ()> (GPA( "glInitNames" ));
	qglInterleavedArrays         =  dllInterleavedArrays         = reinterpret_cast<void (WINAPI*) (GLenum, GLsizei, const GLvoid*)> (GPA( "glInterleavedArrays" ));
	qglIsEnabled                 =  dllIsEnabled                 = reinterpret_cast<GLboolean (WINAPI*) (GLenum)> (GPA( "glIsEnabled" ));
	qglIsList                    =  dllIsList                    = reinterpret_cast<GLboolean (WINAPI*) (GLuint)> (GPA( "glIsList" ));
	qglIsTexture                 =  dllIsTexture                 = reinterpret_cast<GLboolean (WINAPI*) (GLuint)> (GPA( "glIsTexture" ));
	qglLightModelf               =  dllLightModelf               = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat)> (GPA( "glLightModelf" ));
	qglLightModelfv              =  dllLightModelfv              = reinterpret_cast<void (WINAPI*) (GLenum, const GLfloat*)> (GPA( "glLightModelfv" ));
	qglLightModeli               =  dllLightModeli               = reinterpret_cast<void (WINAPI*) (GLenum, GLint)> (GPA( "glLightModeli" ));
	qglLightModeliv              =  dllLightModeliv              = reinterpret_cast<void (WINAPI*) (GLenum, const GLint*)> (GPA( "glLightModeliv" ));
	qglLightf                    =  dllLightf                    = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat)> (GPA( "glLightf" ));
	qglLightfv                   =  dllLightfv                   = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLfloat*)> (GPA( "glLightfv" ));
	qglLighti                    =  dllLighti                    = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint)> (GPA( "glLighti" ));
	qglLightiv                   =  dllLightiv                   = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLint*)> (GPA( "glLightiv" ));
	qglLineStipple               =  dllLineStipple               = reinterpret_cast<void (WINAPI*) (GLint, GLushort)> (GPA( "glLineStipple" ));
	qglLineWidth                 =  dllLineWidth                 = reinterpret_cast<void (WINAPI*) (GLfloat)> (GPA( "glLineWidth" ));
	qglListBase                  =  dllListBase                  = reinterpret_cast<void (WINAPI*) (GLuint)> (GPA( "glListBase" ));
	qglLoadIdentity              =  dllLoadIdentity              = reinterpret_cast<void (WINAPI*) ()> (GPA( "glLoadIdentity" ));
	qglLoadMatrixd               =  dllLoadMatrixd               = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glLoadMatrixd" ));
	qglLoadMatrixf               =  dllLoadMatrixf               = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glLoadMatrixf" ));
	qglLoadName                  =  dllLoadName                  = reinterpret_cast<void (WINAPI*) (GLuint)> (GPA( "glLoadName" ));
	qglLogicOp                   =  dllLogicOp                   = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glLogicOp" ));
	qglMap1d                     =  dllMap1d                     = reinterpret_cast<void (WINAPI*) (GLenum, GLdouble, GLdouble, GLint, GLint, const GLdouble*)> (GPA( "glMap1d" ));
	qglMap1f                     =  dllMap1f                     = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat, GLfloat, GLint, GLint, const GLfloat*)> (GPA( "glMap1f" ));
	qglMap2d                     =  dllMap2d                     = reinterpret_cast<void (WINAPI*) (GLenum, GLdouble, GLdouble, GLint, GLint, GLdouble, GLdouble, GLint, GLint, const GLdouble*)> (GPA( "glMap2d" ));
	qglMap2f                     =  dllMap2f                     = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat, GLfloat, GLint, GLint, GLfloat, GLfloat, GLint, GLint, const GLfloat*)> (GPA( "glMap2f" ));
	qglMapGrid1d                 =  dllMapGrid1d                 = reinterpret_cast<void (WINAPI*) (GLint, GLdouble, GLdouble)> (GPA( "glMapGrid1d" ));
	qglMapGrid1f                 =  dllMapGrid1f                 = reinterpret_cast<void (WINAPI*) (GLint, GLfloat, GLfloat)> (GPA( "glMapGrid1f" ));
	qglMapGrid2d                 =  dllMapGrid2d                 = reinterpret_cast<void (WINAPI*) (GLint, GLdouble, GLdouble, GLint, GLdouble, GLdouble)> (GPA( "glMapGrid2d" ));
	qglMapGrid2f                 =  dllMapGrid2f                 = reinterpret_cast<void (WINAPI*) (GLint, GLfloat, GLfloat, GLint, GLfloat, GLfloat)> (GPA( "glMapGrid2f" ));
	qglMaterialf                 =  dllMaterialf                 = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat)> (GPA( "glMaterialf" ));
	qglMaterialfv                =  dllMaterialfv                = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLfloat*)> (GPA( "glMaterialfv" ));
	qglMateriali                 =  dllMateriali                 = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint)> (GPA( "glMateriali" ));
	qglMaterialiv                =  dllMaterialiv                = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLint*)> (GPA( "glMaterialiv" ));
	qglMatrixMode                =  dllMatrixMode                = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glMatrixMode" ));
	qglMultMatrixd               =  dllMultMatrixd               = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glMultMatrixd" ));
	qglMultMatrixf               =  dllMultMatrixf               = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glMultMatrixf" ));
	qglNewList                   =  dllNewList                   = reinterpret_cast<void (WINAPI*) (GLuint, GLenum)> (GPA( "glNewList" ));
	qglNormal3b                  =  dllNormal3b                  = reinterpret_cast<void (WINAPI*) (GLbyte, GLbyte, GLbyte)> (GPA( "glNormal3b" ));
	qglNormal3bv                 =  dllNormal3bv                 = reinterpret_cast<void (WINAPI*) (const GLbyte*)> (GPA( "glNormal3bv" ));
	qglNormal3d                  =  dllNormal3d                  = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble)> (GPA( "glNormal3d" ));
	qglNormal3dv                 =  dllNormal3dv                 = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glNormal3dv" ));
	qglNormal3f                  =  dllNormal3f                  = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat)> (GPA( "glNormal3f" ));
	qglNormal3fv                 =  dllNormal3fv                 = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glNormal3fv" ));
	qglNormal3i                  =  dllNormal3i                  = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint)> (GPA( "glNormal3i" ));
	qglNormal3iv                 =  dllNormal3iv                 = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glNormal3iv" ));
	qglNormal3s                  =  dllNormal3s                  = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort)> (GPA( "glNormal3s" ));
	qglNormal3sv                 =  dllNormal3sv                 = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glNormal3sv" ));
	qglNormalPointer             =  dllNormalPointer             = reinterpret_cast<void (WINAPI*) (GLenum, GLsizei, const GLvoid*)> (GPA( "glNormalPointer" ));
	qglOrtho                     =  dllOrtho                     = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble)> (GPA( "glOrtho" ));
	qglPassThrough               =  dllPassThrough               = reinterpret_cast<void (WINAPI*) (GLfloat)> (GPA( "glPassThrough" ));
	qglPixelMapfv                =  dllPixelMapfv                = reinterpret_cast<void (WINAPI*) (GLenum, GLsizei, const GLfloat*)> (GPA( "glPixelMapfv" ));
	qglPixelMapuiv               =  dllPixelMapuiv               = reinterpret_cast<void (WINAPI*) (GLenum, GLsizei, const GLuint*)> (GPA( "glPixelMapuiv" ));
	qglPixelMapusv               =  dllPixelMapusv               = reinterpret_cast<void (WINAPI*) (GLenum, GLsizei, const GLushort*)> (GPA( "glPixelMapusv" ));
	qglPixelStoref               =  dllPixelStoref               = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat)> (GPA( "glPixelStoref" ));
	qglPixelStorei               =  dllPixelStorei               = reinterpret_cast<void (WINAPI*) (GLenum, GLint)> (GPA( "glPixelStorei" ));
	qglPixelTransferf            =  dllPixelTransferf            = reinterpret_cast<void (WINAPI*) (GLenum, GLfloat)> (GPA( "glPixelTransferf" ));
	qglPixelTransferi            =  dllPixelTransferi            = reinterpret_cast<void (WINAPI*) (GLenum, GLint)> (GPA( "glPixelTransferi" ));
	qglPixelZoom                 =  dllPixelZoom                 = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat)> (GPA( "glPixelZoom" ));
	qglPointSize                 =  dllPointSize                 = reinterpret_cast<void (WINAPI*) (GLfloat)> (GPA( "glPointSize" ));
	qglPolygonMode               =  dllPolygonMode               = reinterpret_cast<void (WINAPI*) (GLenum, GLenum)> (GPA( "glPolygonMode" ));
	qglPolygonOffset             =  dllPolygonOffset             = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat)> (GPA( "glPolygonOffset" ));
	qglPolygonStipple            =  dllPolygonStipple            = reinterpret_cast<void (WINAPI*) (const GLubyte*)> (GPA( "glPolygonStipple" ));
	qglPopAttrib                 =  dllPopAttrib                 = reinterpret_cast<void (WINAPI*) ()> (GPA( "glPopAttrib" ));
	qglPopClientAttrib           =  dllPopClientAttrib           = reinterpret_cast<void (WINAPI*) ()> (GPA( "glPopClientAttrib" ));
	qglPopMatrix                 =  dllPopMatrix                 = reinterpret_cast<void (WINAPI*) ()> (GPA( "glPopMatrix" ));
	qglPopName                   =  dllPopName                   = reinterpret_cast<void (WINAPI*) ()> (GPA( "glPopName" ));
	qglPrioritizeTextures        =  dllPrioritizeTextures        = reinterpret_cast<void (WINAPI*) (GLsizei, const GLuint*, const GLclampf*)> (GPA( "glPrioritizeTextures" ));
	qglPushAttrib                =  dllPushAttrib                = reinterpret_cast<void (WINAPI*) (GLbitfield)> (GPA( "glPushAttrib" ));
	qglPushClientAttrib          =  dllPushClientAttrib          = reinterpret_cast<void (WINAPI*) (GLbitfield)> (GPA( "glPushClientAttrib" ));
	qglPushMatrix                =  dllPushMatrix                = reinterpret_cast<void (WINAPI*) ()> (GPA( "glPushMatrix" ));
	qglPushName                  =  dllPushName                  = reinterpret_cast<void (WINAPI*) (GLuint)> (GPA( "glPushName" ));
	qglRasterPos2d               =  dllRasterPos2d               = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble)> (GPA( "glRasterPos2d" ));
	qglRasterPos2dv              =  dllRasterPos2dv              = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glRasterPos2dv" ));
	qglRasterPos2f               =  dllRasterPos2f               = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat)> (GPA( "glRasterPos2f" ));
	qglRasterPos2fv              =  dllRasterPos2fv              = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glRasterPos2fv" ));
	qglRasterPos2i               =  dllRasterPos2i               = reinterpret_cast<void (WINAPI*) (GLint, GLint)> (GPA( "glRasterPos2i" ));
	qglRasterPos2iv              =  dllRasterPos2iv              = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glRasterPos2iv" ));
	qglRasterPos2s               =  dllRasterPos2s               = reinterpret_cast<void (WINAPI*) (GLshort, GLshort)> (GPA( "glRasterPos2s" ));
	qglRasterPos2sv              =  dllRasterPos2sv              = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glRasterPos2sv" ));
	qglRasterPos3d               =  dllRasterPos3d               = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble)> (GPA( "glRasterPos3d" ));
	qglRasterPos3dv              =  dllRasterPos3dv              = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glRasterPos3dv" ));
	qglRasterPos3f               =  dllRasterPos3f               = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat)> (GPA( "glRasterPos3f" ));
	qglRasterPos3fv              =  dllRasterPos3fv              = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glRasterPos3fv" ));
	qglRasterPos3i               =  dllRasterPos3i               = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint)> (GPA( "glRasterPos3i" ));
	qglRasterPos3iv              =  dllRasterPos3iv              = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glRasterPos3iv" ));
	qglRasterPos3s               =  dllRasterPos3s               = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort)> (GPA( "glRasterPos3s" ));
	qglRasterPos3sv              =  dllRasterPos3sv              = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glRasterPos3sv" ));
	qglRasterPos4d               =  dllRasterPos4d               = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble, GLdouble)> (GPA( "glRasterPos4d" ));
	qglRasterPos4dv              =  dllRasterPos4dv              = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glRasterPos4dv" ));
	qglRasterPos4f               =  dllRasterPos4f               = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat, GLfloat)> (GPA( "glRasterPos4f" ));
	qglRasterPos4fv              =  dllRasterPos4fv              = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glRasterPos4fv" ));
	qglRasterPos4i               =  dllRasterPos4i               = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint, GLint)> (GPA( "glRasterPos4i" ));
	qglRasterPos4iv              =  dllRasterPos4iv              = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glRasterPos4iv" ));
	qglRasterPos4s               =  dllRasterPos4s               = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort, GLshort)> (GPA( "glRasterPos4s" ));
	qglRasterPos4sv              =  dllRasterPos4sv              = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glRasterPos4sv" ));
	qglReadBuffer                =  dllReadBuffer                = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glReadBuffer" ));
	qglReadPixels                =  dllReadPixels                = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, GLvoid*)> (GPA( "glReadPixels" ));
	qglRectd                     =  dllRectd                     = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble, GLdouble)> (GPA( "glRectd" ));
	qglRectdv                    =  dllRectdv                    = reinterpret_cast<void (WINAPI*) (const GLdouble*, const GLdouble*)> (GPA( "glRectdv" ));
	qglRectf                     =  dllRectf                     = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat, GLfloat)> (GPA( "glRectf" ));
	qglRectfv                    =  dllRectfv                    = reinterpret_cast<void (WINAPI*) (const GLfloat*, const GLfloat*)> (GPA( "glRectfv" ));
	qglRecti                     =  dllRecti                     = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint, GLint)> (GPA( "glRecti" ));
	qglRectiv                    =  dllRectiv                    = reinterpret_cast<void (WINAPI*) (const GLint*, const GLint*)> (GPA( "glRectiv" ));
	qglRects                     =  dllRects                     = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort, GLshort)> (GPA( "glRects" ));
	qglRectsv                    =  dllRectsv                    = reinterpret_cast<void (WINAPI*) (const GLshort*, const GLshort*)> (GPA( "glRectsv" ));
	qglRenderMode                =  dllRenderMode                = reinterpret_cast<GLint (WINAPI*) (GLenum)> (GPA( "glRenderMode" ));
	qglRotated                   =  dllRotated                   = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble, GLdouble)> (GPA( "glRotated" ));
	qglRotatef                   =  dllRotatef                   = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat, GLfloat)> (GPA( "glRotatef" ));
	qglScaled                    =  dllScaled                    = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble)> (GPA( "glScaled" ));
	qglScalef                    =  dllScalef                    = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat)> (GPA( "glScalef" ));
	qglScissor                   =  dllScissor                   = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLsizei, GLsizei)> (GPA( "glScissor" ));
	qglSelectBuffer              =  dllSelectBuffer              = reinterpret_cast<void (WINAPI*) (GLsizei, GLuint*)> (GPA( "glSelectBuffer" ));
	qglShadeModel                =  dllShadeModel                = reinterpret_cast<void (WINAPI*) (GLenum)> (GPA( "glShadeModel" ));
	qglStencilFunc               =  dllStencilFunc               = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLuint)> (GPA( "glStencilFunc" ));
	qglStencilMask               =  dllStencilMask               = reinterpret_cast<void (WINAPI*) (GLuint)> (GPA( "glStencilMask" ));
	qglStencilOp                 =  dllStencilOp                 = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLenum)> (GPA( "glStencilOp" ));
	qglTexCoord1d                =  dllTexCoord1d                = reinterpret_cast<void (WINAPI*) (GLdouble)> (GPA( "glTexCoord1d" ));
	qglTexCoord1dv               =  dllTexCoord1dv               = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glTexCoord1dv" ));
	qglTexCoord1f                =  dllTexCoord1f                = reinterpret_cast<void (WINAPI*) (GLfloat)> (GPA( "glTexCoord1f" ));
	qglTexCoord1fv               =  dllTexCoord1fv               = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glTexCoord1fv" ));
	qglTexCoord1i                =  dllTexCoord1i                = reinterpret_cast<void (WINAPI*) (GLint)> (GPA( "glTexCoord1i" ));
	qglTexCoord1iv               =  dllTexCoord1iv               = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glTexCoord1iv" ));
	qglTexCoord1s                =  dllTexCoord1s                = reinterpret_cast<void (WINAPI*) (GLshort)> (GPA( "glTexCoord1s" ));
	qglTexCoord1sv               =  dllTexCoord1sv               = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glTexCoord1sv" ));
	qglTexCoord2d                =  dllTexCoord2d                = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble)> (GPA( "glTexCoord2d" ));
	qglTexCoord2dv               =  dllTexCoord2dv               = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glTexCoord2dv" ));
	qglTexCoord2f                =  dllTexCoord2f                = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat)> (GPA( "glTexCoord2f" ));
	qglTexCoord2fv               =  dllTexCoord2fv               = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glTexCoord2fv" ));
	qglTexCoord2i                =  dllTexCoord2i                = reinterpret_cast<void (WINAPI*) (GLint, GLint)> (GPA( "glTexCoord2i" ));
	qglTexCoord2iv               =  dllTexCoord2iv               = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glTexCoord2iv" ));
	qglTexCoord2s                =  dllTexCoord2s                = reinterpret_cast<void (WINAPI*) (GLshort, GLshort)> (GPA( "glTexCoord2s" ));
	qglTexCoord2sv               =  dllTexCoord2sv               = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glTexCoord2sv" ));
	qglTexCoord3d                =  dllTexCoord3d                = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble)> (GPA( "glTexCoord3d" ));
	qglTexCoord3dv               =  dllTexCoord3dv               = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glTexCoord3dv" ));
	qglTexCoord3f                =  dllTexCoord3f                = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat)> (GPA( "glTexCoord3f" ));
	qglTexCoord3fv               =  dllTexCoord3fv               = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glTexCoord3fv" ));
	qglTexCoord3i                =  dllTexCoord3i                = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint)> (GPA( "glTexCoord3i" ));
	qglTexCoord3iv               =  dllTexCoord3iv               = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glTexCoord3iv" ));
	qglTexCoord3s                =  dllTexCoord3s                = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort)> (GPA( "glTexCoord3s" ));
	qglTexCoord3sv               =  dllTexCoord3sv               = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glTexCoord3sv" ));
	qglTexCoord4d                =  dllTexCoord4d                = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble, GLdouble)> (GPA( "glTexCoord4d" ));
	qglTexCoord4dv               =  dllTexCoord4dv               = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glTexCoord4dv" ));
	qglTexCoord4f                =  dllTexCoord4f                = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat, GLfloat)> (GPA( "glTexCoord4f" ));
	qglTexCoord4fv               =  dllTexCoord4fv               = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glTexCoord4fv" ));
	qglTexCoord4i                =  dllTexCoord4i                = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint, GLint)> (GPA( "glTexCoord4i" ));
	qglTexCoord4iv               =  dllTexCoord4iv               = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glTexCoord4iv" ));
	qglTexCoord4s                =  dllTexCoord4s                = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort, GLshort)> (GPA( "glTexCoord4s" ));
	qglTexCoord4sv               =  dllTexCoord4sv               = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glTexCoord4sv" ));
	qglTexCoordPointer           =  dllTexCoordPointer           = reinterpret_cast<void (WINAPI*) (GLint, GLenum, GLsizei, const GLvoid*)> (GPA( "glTexCoordPointer" ));
	qglTexEnvf                   =  dllTexEnvf                   = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat)> (GPA( "glTexEnvf" ));
	qglTexEnvfv                  =  dllTexEnvfv                  = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLfloat*)> (GPA( "glTexEnvfv" ));
	qglTexEnvi                   =  dllTexEnvi                   = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint)> (GPA( "glTexEnvi" ));
	qglTexEnviv                  =  dllTexEnviv                  = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLint*)> (GPA( "glTexEnviv" ));
	qglTexGend                   =  dllTexGend                   = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLdouble)> (GPA( "glTexGend" ));
	qglTexGendv                  =  dllTexGendv                  = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLdouble*)> (GPA( "glTexGendv" ));
	qglTexGenf                   =  dllTexGenf                   = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat)> (GPA( "glTexGenf" ));
	qglTexGenfv                  =  dllTexGenfv                  = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLfloat*)> (GPA( "glTexGenfv" ));
	qglTexGeni                   =  dllTexGeni                   = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint)> (GPA( "glTexGeni" ));
	qglTexGeniv                  =  dllTexGeniv                  = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLint*)> (GPA( "glTexGeniv" ));
	qglTexImage1D                =  dllTexImage1D                = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLint, GLsizei, GLint, GLenum, GLenum, const GLvoid*)> (GPA( "glTexImage1D" ));
	qglTexImage2D                =  dllTexImage2D                = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLint, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid*)> (GPA( "glTexImage2D" ));
	qglTexParameterf             =  dllTexParameterf             = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLfloat)> (GPA( "glTexParameterf" ));
	qglTexParameterfv            =  dllTexParameterfv            = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLfloat*)> (GPA( "glTexParameterfv" ));
	qglTexParameteri             =  dllTexParameteri             = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, GLint)> (GPA( "glTexParameteri" ));
	qglTexParameteriv            =  dllTexParameteriv            = reinterpret_cast<void (WINAPI*) (GLenum, GLenum, const GLint*)> (GPA( "glTexParameteriv" ));
	qglTexSubImage1D             =  dllTexSubImage1D             = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLint, GLsizei, GLenum, GLenum, const GLvoid*)> (GPA( "glTexSubImage1D" ));
	qglTexSubImage2D             =  dllTexSubImage2D             = reinterpret_cast<void (WINAPI*) (GLenum, GLint, GLint, GLint, GLsizei, GLsizei, GLenum, GLenum, const GLvoid*)> (GPA( "glTexSubImage2D" ));
	qglTranslated                =  dllTranslated                = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble)> (GPA( "glTranslated" ));
	qglTranslatef                =  dllTranslatef                = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat)> (GPA( "glTranslatef" ));
	qglVertex2d                  =  dllVertex2d                  = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble)> (GPA( "glVertex2d" ));
	qglVertex2dv                 =  dllVertex2dv                 = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glVertex2dv" ));
	qglVertex2f                  =  dllVertex2f                  = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat)> (GPA( "glVertex2f" ));
	qglVertex2fv                 =  dllVertex2fv                 = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glVertex2fv" ));
	qglVertex2i                  =  dllVertex2i                  = reinterpret_cast<void (WINAPI*) (GLint, GLint)> (GPA( "glVertex2i" ));
	qglVertex2iv                 =  dllVertex2iv                 = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glVertex2iv" ));
	qglVertex2s                  =  dllVertex2s                  = reinterpret_cast<void (WINAPI*) (GLshort, GLshort)> (GPA( "glVertex2s" ));
	qglVertex2sv                 =  dllVertex2sv                 = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glVertex2sv" ));
	qglVertex3d                  =  dllVertex3d                  = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble)> (GPA( "glVertex3d" ));
	qglVertex3dv                 =  dllVertex3dv                 = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glVertex3dv" ));
	qglVertex3f                  =  dllVertex3f                  = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat)> (GPA( "glVertex3f" ));
	qglVertex3fv                 =  dllVertex3fv                 = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glVertex3fv" ));
	qglVertex3i                  =  dllVertex3i                  = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint)> (GPA( "glVertex3i" ));
	qglVertex3iv                 =  dllVertex3iv                 = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glVertex3iv" ));
	qglVertex3s                  =  dllVertex3s                  = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort)> (GPA( "glVertex3s" ));
	qglVertex3sv                 =  dllVertex3sv                 = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glVertex3sv" ));
	qglVertex4d                  =  dllVertex4d                  = reinterpret_cast<void (WINAPI*) (GLdouble, GLdouble, GLdouble, GLdouble)> (GPA( "glVertex4d" ));
	qglVertex4dv                 =  dllVertex4dv                 = reinterpret_cast<void (WINAPI*) (const GLdouble*)> (GPA( "glVertex4dv" ));
	qglVertex4f                  =  dllVertex4f                  = reinterpret_cast<void (WINAPI*) (GLfloat, GLfloat, GLfloat, GLfloat)> (GPA( "glVertex4f" ));
	qglVertex4fv                 =  dllVertex4fv                 = reinterpret_cast<void (WINAPI*) (const GLfloat*)> (GPA( "glVertex4fv" ));
	qglVertex4i                  =  dllVertex4i                  = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLint, GLint)> (GPA( "glVertex4i" ));
	qglVertex4iv                 =  dllVertex4iv                 = reinterpret_cast<void (WINAPI*) (const GLint*)> (GPA( "glVertex4iv" ));
	qglVertex4s                  =  dllVertex4s                  = reinterpret_cast<void (WINAPI*) (GLshort, GLshort, GLshort, GLshort)> (GPA( "glVertex4s" ));
	qglVertex4sv                 =  dllVertex4sv                 = reinterpret_cast<void (WINAPI*) (const GLshort*)> (GPA( "glVertex4sv" ));
	qglVertexPointer             =  dllVertexPointer             = reinterpret_cast<void (WINAPI*) (GLint, GLenum, GLsizei, const GLvoid*)> (GPA( "glVertexPointer" ));
	qglViewport                  =  dllViewport                  = reinterpret_cast<void (WINAPI*) (GLint, GLint, GLsizei, GLsizei)> (GPA( "glViewport" ));

	qwglCopyContext             = reinterpret_cast<BOOL (WINAPI*) (HGLRC, HGLRC, UINT)> (GPA( "wglCopyContext" ));
	qwglCreateContext           = reinterpret_cast<HGLRC (WINAPI*) (HDC)> (GPA( "wglCreateContext" ));
	qwglCreateLayerContext      = reinterpret_cast<HGLRC (WINAPI*) (HDC, int)> (GPA( "wglCreateLayerContext" ));
	qwglDeleteContext           = reinterpret_cast<BOOL (WINAPI*) (HGLRC)> (GPA( "wglDeleteContext" ));
	qwglDescribeLayerPlane      = reinterpret_cast<BOOL (WINAPI*) (HDC, int, int, UINT, LPLAYERPLANEDESCRIPTOR)> (GPA( "wglDescribeLayerPlane" ));
	qwglGetCurrentContext       = reinterpret_cast<HGLRC (WINAPI*) ()> (GPA( "wglGetCurrentContext" ));
	qwglGetCurrentDC            = reinterpret_cast<HDC (WINAPI*) ()> (GPA( "wglGetCurrentDC" ));
	qwglGetLayerPaletteEntries  = reinterpret_cast<int (WINAPI*) (HDC, int, int, int, COLORREF*)> (GPA( "wglGetLayerPaletteEntries" ));
	qwglGetProcAddress          = reinterpret_cast<PROC (WINAPI*) (LPCSTR)> (GPA( "wglGetProcAddress" ));
	qwglMakeCurrent             = reinterpret_cast<BOOL (WINAPI*) (HDC, HGLRC)> (GPA( "wglMakeCurrent" ));
	qwglRealizeLayerPalette     = reinterpret_cast<BOOL (WINAPI*) (HDC, int, BOOL)> (GPA( "wglRealizeLayerPalette" ));
	qwglSetLayerPaletteEntries  = reinterpret_cast<int (WINAPI*) (HDC, int, int, int, const COLORREF*)> (GPA( "wglSetLayerPaletteEntries" ));
	qwglShareLists              = reinterpret_cast<BOOL (WINAPI*) (HGLRC, HGLRC)> (GPA( "wglShareLists" ));
	qwglSwapLayerBuffers        = reinterpret_cast<BOOL (WINAPI*) (HDC, UINT)> (GPA( "wglSwapLayerBuffers" ));
	qwglUseFontBitmaps          = reinterpret_cast<BOOL (WINAPI*) (HDC, DWORD, DWORD, DWORD)> (GPA( "wglUseFontBitmapsA" ));
	qwglUseFontOutlines         = reinterpret_cast<BOOL (WINAPI*) (HDC, DWORD, DWORD, DWORD, FLOAT, FLOAT, int, LPGLYPHMETRICSFLOAT)> (GPA( "wglUseFontOutlinesA" ));

	qwglChoosePixelFormat       = reinterpret_cast<int (WINAPI*) (HDC, const PIXELFORMATDESCRIPTOR*)> (GPA( "wglChoosePixelFormat" ));
	qwglDescribePixelFormat     = reinterpret_cast<int (WINAPI*) (HDC, int, UINT, LPPIXELFORMATDESCRIPTOR)> (GPA( "wglDescribePixelFormat" ));
	qwglGetPixelFormat          = reinterpret_cast<int (WINAPI*) (HDC)> (GPA( "wglGetPixelFormat" ));
	qwglSetPixelFormat          = reinterpret_cast<BOOL (WINAPI*) (HDC, int, const PIXELFORMATDESCRIPTOR*)> (GPA( "wglSetPixelFormat" ));
	qwglSwapBuffers             = reinterpret_cast<BOOL (WINAPI*) (HDC)> (GPA( "wglSwapBuffers" ));
