...
//
//	out = static_cast<byte*> (R_GetImageBuffer( cinfo.output_width * cinfo.output_height * cinfo.output_components, BUFFER_IMAGE ));
//
//	*pic = out;
...
//	 */
//	out = static_cast<byte*> (ri.Hunk_AllocateTempMemory( image_width * image_height * 4 ));
