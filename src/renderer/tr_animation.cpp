...
//----(SA)	end
		...
		if ( !personalModel ) {
			...
			R_AddDrawSurf( reinterpret_cast<surfaceType_t*> (surface), shader, fogNum, qfalse, ATI_TESS_TRUFORM );
#elif defined RTCW_MP
...
#elif defined RTCW_MP
	pIndexes = reinterpret_cast<int*> ((int*)&tess.indexes[baseIndex]);
#endif // RTCW_XX
...
#elif defined RTCW_MP
			pIndexes = reinterpret_cast<int*> ((int*)&tess.indexes[oldIndexes]);
#endif // RTCW_XX
